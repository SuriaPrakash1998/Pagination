...
previousElement.innerHTML = `<a class="page-link">${previous}</a>`
previousElement.addEventListener('click',previousButton)

let firstElement = document.getElementById('first-element')
firstElement.innerHTML = `<a class="page-link">${first}</a>`
firstElement.addEventListener('click',firstAction)

let secondElement = document.getElementById('second-element')
secondElement.innerHTML = `<a class="page-link">${second}</a>`
secondElement.addEventListener('click',secondAction)

let thirdElement = document.getElementById('third-element')
thirdElement.innerHTML = `<a class="page-link">${third}</a>`
thirdElement.addEventListener('click',thirdAction)

let fourthElement = document.getElementById('fourth-element')
fourthElement.innerHTML = `<a class="page-link">${fourth}</a>`
fourthElement.addEventListener('click',fourthAction)

let fifthElement = document.getElementById('fifth-element')
fifthElement.innerHTML = `<a class="page-link">${fifth}</a>`
fifthElement.addEventListener('click',fifthAction)

let nextElement = document.getElementById('next-element')
nextElement.innerHTML = `<a class="page-link">${next}</a>`
nextElement.addEventListener('click',nextButton)
...
id.innerHTML='';
id.setAttribute('class','idClass')
navigator.appendChild(id)
...
email.setAttribute('class','emailClass')
email.innerHTML='';
navigator.appendChild(email)

function firstAction(e){
e = first-1
name.innerHTML=`Name : ${dataArr[e]['name']}`;
email.innerHTML=`Email : ${dataArr[e]['email']}`;
id.innerHTML=`Id : ${dataArr[e]['id']}`
firstElement.setAttribute('class','page-item active')
secondElement.setAttribute('class','page-item ')
thirdElement.setAttribute('class','page-item ')
fourthElement.setAttribute('class','page-item ')
fifthElement.setAttribute('class','page-item ')
 ...
 function secondAction(e){
  ...
  id.innerHTML=`Id : ${dataArr[e]['id']}`;
  firstElement.setAttribute('class','page-item ')
  secondElement.setAttribute('class','page-item active')
  thirdElement.setAttribute('class','page-item ')
  fourthElement.setAttribute('class','page-item ')
  fifthElement.setAttribute('class','page-item ')
   }

   function thirdAction(e){
    e = third-1
    name.innerHTML=`Name : ${dataArr[e]['name']}`;
    email.innerHTML=`Email : ${dataArr[e]['email']}`;
    id.innerHTML=`Id : ${dataArr[e]['id']}`;
    firstElement.setAttribute('class','page-item ')
    secondElement.setAttribute('class','page-item ')
    thirdElement.setAttribute('class','page-item active')
    fourthElement.setAttribute('class','page-item ')
    fifthElement.setAttribute('class','page-item ')
     }

     function fourthAction(e){
      e = fourth-1
      name.innerHTML=`Name : ${dataArr[e]['name']}`;
      email.innerHTML=`Email : ${dataArr[e]['email']}`;
      id.innerHTML=`Id : ${dataArr[e]['id']}`;
      ...
      secondElement.setAttribute('class','page-item ')
      thirdElement.setAttribute('class','page-item ')
      fourthElement.setAttribute('class','page-item active')
      fifthElement.setAttribute('class','page-item ')
       }

       function fifthAction(e){
        e = fifth-1
        name.innerHTML=`Name : ${dataArr[e]['name']}`;
        email.innerHTML=`Email : ${dataArr[e]['email']}`;
        id.innerHTML=`Id : ${dataArr[e]['id']}`;
        ...
        thirdElement.setAttribute('class','page-item ')
        fourthElement.setAttribute('class','page-item ')
        fifthElement.setAttribute('class','page-item active')
         }